...
public class WildPig : Enemy
{
    ...
    //AI巡逻功能,在没有目标的情况下
           if(distance >= radius)
           {
                transform.position = Vector2.MoveTowards(transform.localPosition , theNextMovePos.localPosition , movespeed * Time.deltaTime);//逐渐向目标移动
