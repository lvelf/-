...
public class ThirdScene_FightRoom3 : MonoBehaviour
{
  //掉落宝箱功能
    ...
    private void OnTriggerEnter2D(Collider2D other)
    {
        ...
        {
            Door1_real = Instantiate( Door_Horizontal,Door1.position,Quaternion.identity);
            Door2_real = Instantiate(Door,Door2.position,Quaternion.identity);
            isCreated = true;
        }
    }
}
